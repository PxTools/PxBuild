...
class TestCubes1nn:
    ...
    def test_cube_101_ok(self):
        ...
        pxbuild.LoadFromPxmetadata("101", self._my_config)
        file = "tab_101.px"
    ...
    def test_cube_102_ok(self):
        self.set_path()
        pxbuild.LoadFromPxmetadata("102", self._my_config)
        file = "tab_102.px"
    ...
    def test_cube_103_ok(self):
        self.set_path()
        pxbuild.LoadFromPxmetadata("103", self._my_config)
        file = "tab_103.px"
    ...
    def test_cube_104_ok(self):
        self.set_path()
        pxbuild.LoadFromPxmetadata("104", self._my_config)
        file = "tab_104.px"
    ...
    def test_cube_130_as_103_but_with_stupid_columnnames_csv(self):
        self.set_path()
        pxbuild.LoadFromPxmetadata("130", self._my_config)
        file = "tab_130.px"
    ...
    def test_cube_131_as_103_but_with_stupid_columnnames_parquet(self):
        self.set_path()
        pxbuild.LoadFromPxmetadata("131", self._my_config)
        file = "tab_131.px"
