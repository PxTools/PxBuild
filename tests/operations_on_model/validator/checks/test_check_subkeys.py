...
def test_check_subkeys_values_fails_no_such_value():
    ...
    val_rep = check_valuebased_subkeys(pxfile)
    assert val_rep.is_valid == False 
    assert "For keyword CELLNOTE: Cannot find item no_such_value in VALUES for vaiable:var3_sv and lang:sv." in val_rep.error_msg
...
def test_check_subkeys_for_precision_fails_variable_missing():
    ...
    val_rep = check_valuebased_subkeys(pxfile)
    assert val_rep.is_valid == False 
    assert "For keyword PRECISION: Cannot find variable no_such_thing in stub + heading. For lang:fi." in val_rep.error_msg
...
def test_check_subkeys_for_precision_fails_value_missing():
    ...
    val_rep = check_valuebased_subkeys(pxfile)
    assert val_rep.is_valid == False 
    assert "For keyword PRECISION: Cannot find item no_such_thing in VALUES for vaiable:var1_sv and lang:sv." in val_rep.error_msg
...
def test_check_subkeys_fails_variable_missing():
    ...
    val_rep = check_valuebased_subkeys(pxfile)
    assert val_rep.is_valid == False 
    assert "For keyword DOUBLECOLUMN: Cannot find variable variable_missing in stub + heading. For lang:fi." in val_rep.error_msg
...
def test_check_subkeys_fails_content_missing_from_values():
    ...
    val_rep = check_valuebased_subkeys(pxfile)
    assert val_rep.is_valid == False 
    assert "For keyword DAYADJ: Cannot find item missing_cont_val in VALUES for vaiable:var2_fi and lang:fi." in val_rep.error_msg
