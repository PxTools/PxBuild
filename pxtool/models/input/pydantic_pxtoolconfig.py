...
#   timestamp: 2023-09-11T10:17:17+00:00
...
class Pxtoolconfig(BaseModel):
    ...
    contvariable: Optional[constr(max_length=256)] = None
    """
    Name for content variable
    """
    datasymbol1: Optional[constr(max_length=20)] = None
    """
    How dots are shown on screen
    """
    datasymbol2: Optional[constr(max_length=20)] = None
    """
    How dots are shown on screen
    """
    datasymbol3: Optional[constr(max_length=20)] = None
    """
    How dots are shown on screen
    """
    datasymbol4: Optional[constr(max_length=20)] = None
    """
    How dots are shown on screen
    """
    datasymbol5: Optional[constr(max_length=20)] = None
    """
    How dots are shown on screen
    """
    datasymbol6: Optional[constr(max_length=20)] = None
    """
    How dots are shown on screen
    """
    datasymbol_nil: Optional[constr(max_length=20)] = Field(None, alias='datasymbolNil')
    """
    How stored - are shown on screen
    """
    datasymbol_sum: Optional[constr(max_length=20)] = Field(None, alias='datasymbolSum')
    """
    This if used to indicate how a sum of differing numbers of dots will be shown. The sum is stored as “…….”.
    """
    source: Optional[constr(max_length=256)] = None
    """
    Name for content variable
    """
