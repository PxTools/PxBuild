...
#   timestamp: 2023-10-05T13:22:30+00:00
...
class OutputDestination(BaseModel):
    ...
    px_folder_format: Optional[str] = Field(
        None, alias='pxFolderFormat', example='example_data/pxtool_output/{id}/'
    )
    """
    Aplies to resourcetype=folders. The folder where the .px-files are written. id is the tableID
    """
    agg_folder_format: Optional[str] = Field(
        None, alias='aggFolderFormat', example='example_data/pxtool_output/id}/'
    )
    """
    Aplies to resourcetype=folders. The folder where the .vs- and .agg-files are written. id is the tableID
    """
